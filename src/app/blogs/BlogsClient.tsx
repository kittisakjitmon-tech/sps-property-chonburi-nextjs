...
export default function BlogsClient({ blogs, loading = false }: BlogsClientProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <h2 className="text-lg font-bold text-gray-800 mb-1">ยังไม่มีบทความ</h2>
              <p className="text-gray-500 text-sm">กลับมาเยี่ยมชมใหม่เร็วๆ นี้</p>
            </div>
          )}
